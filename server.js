  ...
  try {
    ...
    await Promise.all([
      ...
      Product.create({
        ...
        category: "philippines",
        imgUrl:
          "https://corinthiandistributors.com/wp-content/uploads/2020/03/25-1216-4800016052132-C2-Green-Tea-Apple-Drink-500ml-No.1.jpg",
        ml: 250,
      }),
      Product.create({
      ...
      Product.create({
        ...
        category: "philippines",
        imgUrl:
          "https://www.nicepng.com/png/detail/195-1959872_dutchmill-delight-probiotic-drink-delight-drinks.png",
        ml: 250,
      }),
      //'japan'
      Product.create({
