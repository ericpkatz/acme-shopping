...
const setUp = async () => {
  try {
    ...
    Product.create({name: 'Gina Mango Juice', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://cdn.shopify.com/s/files/1/0338/0694/2253/products/GinaMangoNectarJuice11.5oz_front_2048x.jpg?v=1620318585', ml: 240}),
    Product.create({name: 'Mogu Mogu Lychee', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://www.bigbasket.com/media/uploads/p/xxl/288824-2_6-mogu-mogu-juice-lychee.jpg', ml: 250}),
    Product.create({name: 'Mogu Mogu Grape', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://www.asianfoodlovers.com/media/catalog/product/cache/8/image/750x750/9df78eab33525d08d6e5fb8d27136e95/7/5/75135_1.jpg', ml: 250}),
    Product.create({name: 'Mogu Mogu Melon', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://m.media-amazon.com/images/I/715Vj-8YxyL._SL1500_.jpg', ml: 250}),
    Product.create({name: 'Mogu Mogu Mango', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://i5.walmartimages.com/asr/ae858551-f549-4bf0-90b9-00dd1bb995f5.23c4f4824a9ad7edb06abd0e103c41aa.jpeg?odnHeight=612&odnWidth=612&odnBg=FFFFFF', ml: 250}),
    Product.create({name: 'Mogu Mogu Coconut', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://cdn.shopify.com/s/files/1/0256/3473/4166/products/MoguMogu-CoconutJuicewithNataDeCoco-1000ML_500x.jpg?v=1639243157', ml: 250}),
    Product.create({name: 'Mogu Mogu Strawberry', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'http://cdn.shopify.com/s/files/1/1451/6328/products/mogu_strawberry_grande.jpg?v=1631797277', ml: 250}),
    Product.create({name: 'Mogu Mogu Pink Guava', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://m.media-amazon.com/images/I/71a8FoZqPuL._SL1500_.jpg', ml: 250}),
    Product.create({name: 'Mogu Mogu Peach', description: faker.random.words(20), price: 2.99, category: 'philippines', imgUrl: 'https://m.media-amazon.com/images/I/813CRAM8DdL._SL1500_.jpg', ml: 250}),
    Product.create({name: 'Zesto Apple Juice', description: faker.random.words(20), price: 1.99, category: 'philippines', imgUrl: 'https://myecomshop.imgix.net/store_12746/37fbd52aef4458554c1114e652d6b35f.png?ixlib=php-1.2.1&ar=1:1', ml: 250}),
    Product.create({name: 'Zesto Orange Juice', description: faker.random.words(20), price: 1.99, category: 'philippines', imgUrl: 'http://cdn.shopify.com/s/files/1/0500/8421/6991/products/108295_45a9f5f0-0dcf-4255-bfac-16c1317a1f81.jpg?v=1632994569', ml: 250}),
    ...
    Product.create({name: 'Ramune Orange', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://i5.peapod.com/c/B5/B5UC7.png', ml: 250}),
    Product.create({name: 'Ramune Lychee', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://ipcdn.freshop.com/resize?url=https://images.freshop.com/00011152225654/49cd22126c2897128c81e356f5a1a2f1_large.png&width=512&type=webp&quality=90', ml: 250}),
    Product.create({name: 'Ramune Pineapple', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://nikankitchen.com/Images/Products/hata-ramune-soda-pineapple-200-ml.png', ml: 250}),
    Product.create({name: 'Ramune Raspberry', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://images.heb.com/is/image/HEBGrocery/001424805?fit=constrain,1&wid=800&hei=800&fmt=jpg&qlt=85,0&resMode=sharp2&op_usm=1.75,0.3,2,0', ml: 250}),
    Product.create({name: 'Ramune Melon', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://images.heb.com/is/image/HEBGrocery/001261994?fit=constrain,1&wid=800&hei=800&fmt=jpg&qlt=85,0&resMode=sharp2&op_usm=1.75,0.3,2,0', ml: 250}),
    Product.create({name: 'Ramune Strawberry', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://www.meijer.com/content/dam/meijer/product/0001/11/5221/68/0001115221680_1200.png', ml: 250}),
    Product.create({name: 'Ramune Peach', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://images.albertsons-media.com/is/image/ABS/970026405?$ecom-pdp-desktop$&defaultImage=Not_Available', ml: 250}),
    Product.create({name: 'Calpico White Peach', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://ipcdn.freshop.com/resize?url=https://images.freshop.com/00075545006183/7e1ac55e03a9194bc10b699ecb41b607_large.png&width=512&type=webp&quality=90', ml: 250}),
    Product.create({name: 'Calpico Strawberry', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://cdn11.bigcommerce.com/s-ih7nl5lym4/images/stencil/1280x1280/products/24682/50596/11034__74628.1624900388.jpg?c=2', ml: 250}),
    Product.create({name: 'Calpico Mango', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://cdn.shopify.com/s/files/1/0412/3138/4725/products/11032_1280x.jpg?v=1640904058', ml: 250}),
    Product.create({name: 'Calpico Original', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://storage.googleapis.com/images-fol-prd-83dd8b8.fol.prd.v8.commerce.mi9cloud.com/product-images/detail/7554500610.jpg', ml: 250}),
    Product.create({name: 'Tomomasu Mango Soda', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://cdn.shopify.com/s/files/1/0561/3553/products/JP-629_x700.jpg?v=1574878970', ml: 250}),
    Product.create({name: 'Tomomasu Peach Cider', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://cdn.shopify.com/s/files/1/0338/0694/2253/products/TomomasuJapaneseSoda-PeachCider10oz_300ml__front_2048x.jpg?v=1646404506', ml: 250}),
    Product.create({name: 'Tomomasu Watermelon Soda', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://i.ebayimg.com/images/g/E34AAOSwJ7Rb-eTM/s-l500.jpg', ml: 250}),
    Product.create({name: 'Tomomasu Pine Cider', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'http://cdn.shopify.com/s/files/1/0561/3553/products/JP-630_1024x1024.jpg?v=1574878972', ml: 250}),
    Product.create({name: 'Tomomasu Muskmelon Soda', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://i.ebayimg.com/images/g/RUcAAOSwMhVb-eKN/s-l500.jpg', ml: 250}),
    Product.create({name: 'Kimino Yuzu Sparkling Juice', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://m.media-amazon.com/images/I/51Gk7pVehyL._SL1024_.jpg', ml: 250}),
    Product.create({name: 'Kimino Ume Sparkling Juice', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://m.media-amazon.com/images/I/51MZ-QO5qQL.jpg', ml: 250}),
    Product.create({name: 'Kimino Ringo (Apple) Sparkling Juice', description: faker.random.words(20), price: 2.99, category: 'japan', imgUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbDUn5MQzJq21uyEmANNOlShk87ZYBJvoy1g&usqp=CAU', ml: 250}),
    //'korea'
    Product.create({name: 'Binggrae Banana Flavored Milk (pack of 6)', description: faker.random.words(20), price: 4.99, category: 'korea', imgUrl: 'https://cdn.shopify.com/s/files/1/0565/3174/6997/products/Binggrae-Banana-Flavored-Milk-Drink---6pk-200ml.jpg?v=1638557273', ml: 250}),
    Product.create({name: 'Binggrae Melon Flavored Milk (pack of 6)', description: faker.random.words(20), price: 4.99, category: 'korea', imgUrl: 'https://m.media-amazon.com/images/I/517nkjxoUpL.jpg', ml: 250}),
    Product.create({name: 'Binggrae Strawberry Flavored Milk (pack of 6)', description: faker.random.words(20), price: 4.99, category: 'korea', imgUrl: 'https://cdn.shopify.com/s/files/1/0509/0541/5846/products/Untitleddesign121.png?v=1625222252&width=600', ml: 250}),
    Product.create({name: 'Binggrae Lychee and Peach Flavored Milk (pack of 6)', description: faker.random.words(20), price: 4.99, category: 'korea', imgUrl: 'https://cf.shopee.com.my/file/f04c26f05c7bf3d0ac61381877f8515c', ml: 250}),
    Product.create({name: 'Binggrae Coffee Flavored Milk (pack of 6)', description: faker.random.words(20), price: 4.99, category: 'korea', imgUrl: 'https://i5.walmartimages.com/asr/11a0d0a2-757a-4b6b-8a45-2fd98d13b278.e19ba5b57a0e89430f145d86f346c444.png', ml: 250}),
    Product.create({name: 'Lotte Milkis Melon', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://cdn.shopify.com/s/files/1/0338/0694/2253/products/LotteMilkisDrinkCanMelonFlavor8.45oz_Front_2048x.jpg?v=1603995970', ml: 250}),
    Product.create({name: 'Lotte Milkis Peach', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://cdn.shopify.com/s/files/1/0556/8079/4816/products/LotteMilkisDrinkCanPeachFlavor8.45oz_Front_2048x2048_ab105799-13e0-4a01-86ca-115158551b16_530x@2x.jpg?v=1618272263', ml: 250}),
    Product.create({name: 'Lotte Milkis Original', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkbkm_3lgdBLGffD5vWf3VLsa-t5w1TFTdtOYorKM60eqI7vHn8Re0oUrC4fjvSG8noc8&usqp=CAU', ml: 250}),
    Product.create({name: 'Lotte Milkis Grape', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6hz_ljPciWoJ0EmEPWMsrkBxYmYxLBlpef1Y8bQDOKbWSQKR8KUd7-YEkgowqfzBOIjk&usqp=CAU', ml: 250}),
    Product.create({name: 'Lotte Milkis Strawberry', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://cdn.shopify.com/s/files/1/0338/0694/2253/products/LotteMilkisDrinkCanStrawberryFlavor8.45oz_front_2048x.jpg?v=1650574615', ml: 250}),
    Product.create({name: 'Lotte Milkis Banana', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://cdn.shopify.com/s/files/1/0274/7793/4178/products/image_9f012855-9fb6-4d75-92ab-dfcdd8c9db2b_800x.png?v=1641039305', ml: 250}),
    Product.create({name: 'Lotte Milkis Apple', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://munchpak.com/media/catalog/product/cache/image/700x700/e9c3970ab036de70892d86c6d221abfe/m/i/milkis-apple_1.jpg', ml: 250}),
    Product.create({name: 'Lotte Sac Sac Orange', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://images-na.ssl-images-amazon.com/images/I/81RMxMSfmcL._SL1500_.jpg', ml: 250}),
    Product.create({name: 'Lotte Sac Sac Grape', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://i5.walmartimages.com/asr/2947365e-b4a6-4123-bc98-40f8e4d9f854.0d939cb405391c3e8d46d2372184c2b4.jpeg', ml: 250}),
    Product.create({name: 'Lotte Sac Sac Pear', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://s.cornershopapp.com/product-images/3339997.jpg?versionId=vnQ7QFh188_NcrOUd_o4Yk.0sQvgtCLu', ml: 250}),
    Product.create({name: 'Lotte Sac Sac Orange with Coconut Jelly', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://cf.shopee.sg/file/9cc7dcf72fa67e3ab7431980394b62d7', ml: 250}),
    Product.create({name: 'Paldo Sikhye Rice Drink', description: faker.random.words(20), price: 2.99, category: 'korea', imgUrl: 'https://ph-test-11.slatic.net/p/mdc/10bb804778b55383d7c2ad9ea116ab5e.jpg', ml: 250}),
    Product.create({name: 'Woongjin Morning Rice Drink', description: faker.random.words(20), price: 7.99, category: 'korea', imgUrl: 'https://d1jdlez3mwxs70.cloudfront.net/media/catalog/product/cache/ddcfbae445085ab8117c2d65e3aabc27/8/8/8801382124528_4.jpg', ml: 250}),
    Product.create({name: 'Samsiokki MiMi Sikhye Rice Drink (pack of 3)', description: faker.random.words(20), price: 5.99, category: 'korea', imgUrl: 'https://i.ebayimg.com/images/g/n3sAAOSw~sBeS4aK/s-l500.jpg', ml: 250}),
