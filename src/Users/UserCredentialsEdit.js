...
validatePassword(){
    return(
         this.state.password.length>0 && this.state.passwordConfirm.length>0 && this.state.password===this.state.passwordConfirm
         )
   ...
   <div>
    ...
    {this.props.auth.username}
                ...
                <form onSubmit={ update }>
                    ...
                    <button disabled={!validatePassword()} type='submit'>Update Credentials</button>
